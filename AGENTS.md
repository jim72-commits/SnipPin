...
- `NOTICE`: ownership/provenance signature for infringement comparison.
...
- Preserve the project signature `PINSHOT-JIM-2026-PERSONAL-USE-7F3A9C2D` in source, docs, and release materials.
